...
const endpoint = `https://constellation-demo.myshopify.com${SHOPIFY_GRAPHQL_API_ENDPOINT}`
...
export async function shopifyFetch<T>({
  ...
  try {
    ...
    console.log('ddb', variables, body)
...
export async function getCollectionProducts({
  ...
  console.log('Variables:', { handle: collection, reverse, sortKey })
